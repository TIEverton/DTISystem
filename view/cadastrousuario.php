  ...
  <div class="col-md-6">
    <div class="form-group" style="margin-top: 3%;">
      ...
      <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="Digite seu nome e sobrenome." aria-label="Username" aria-describedby="basic-addon1">
      </div>
      ...
      <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="Digite um login." aria-label="Username" aria-describedby="basic-addon1">
      </div>
      ...
      <div class="input-group mb-3">
            ...
            <input type="password" class="form-control" placeholder="Digite uma senha." aria-label="Username" aria-describedby="basic-addon1">
      </div>
      ...
      <div class="input-group mb-3">
            ...
            <input type="email" class="form-control" placeholder="Digite um email válido." aria-label="Username" aria-describedby="basic-addon1">
      </div>
      ...
      <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="Digite seu CPF." aria-label="Username" aria-describedby="basic-addon1">
      </div>

      Nível de Acesso:
      <select class="form-control" id="exampleFormControlSelect1">
          <option>Selecione um nível de acesso:</option>
          <option>Administrador/Funcionário</option>
