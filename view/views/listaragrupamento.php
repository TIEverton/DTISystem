...
include_once '../../controller/agrupamento/Agrupamento.DAO.php';
...
<!-- FIM INCLUDE MENU -->
<?php 
$reser = new agrupamento_DAO;
$resultado = $reser->listarAgrupamento();
?>
...
<table class="table table-striped custab text-center table-bordered">
  <thead>
      <tr class="text-center" style="background-color: #0052aa; color: white;">
          <th>Nome</th>
          <th class="text-center" width="400">Ação</th>
      </tr>
  </thead>
  <?php
  ...
  ?>  
          <tr>
              ...
              <td>
                <a class="btn btn-danger btn-sm" href="../../controller/agrupamento/Agrupamento.controller.php?acao=delete&id=<?php echo $res['id'] ?>" name="acao" onClick="remover()"><i class="fa fa-times-circle" aria-hidden="true"></i> Excluir</span> </a>
                <a class="btn btn-primary btn-sm" href="editaragrupamento.php?id=<?php echo $res['id'] ?>"><i class="fa fa-refresh" aria-hidden="true"></i></i> Atualizar</span> </a>
              </td>
          </tr>
  <?php } ?>
</table>
