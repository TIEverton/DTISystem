...
<head>
    ...
    <title>DTI - Editar Agrupamento &copy;</title>
</head>
<body>
<!-- INCLUDE MENU -->
<?php 
  ...
  $resultaQuery = "SELECT * FROM agrupamento where id= $id";
  ...
  <div class="col-md-6">
    ...
    <input type="hidden" name="id" value="">
      ...
      <div class="input-group mb-3">
            ...
            <input type="text" name="nome" class="form-control" placeholder="Digite o nome do Agrupamento." aria-label="Agrupamento" aria-describedby="basic-addon1" value="<?php if(isset($resultaEditar['nome'])) { echo $resultaEditar['nome']; } ?>">
      </div>
