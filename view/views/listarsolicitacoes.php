                    ...
                    <div class="accordion" id="accordionExample">
                        <div class="card">
                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                <div class="card-body" style="border-bottom: 2px dashed #0052aa; height: 380px;">
                                    <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-success float-right" style="margin-bottom: 10px; margin-top: -5px;"><i class="fa fa-floppy-o" aria-hidden="true"></i> Feito</button></a>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" name="cpf" class="form-control disabled" placeholder="Digite a Matrícula." aria-label="Username" aria-describedby="basic-addon1">
                                        </div>
